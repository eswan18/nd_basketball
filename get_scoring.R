...
files <- list.files(path="~/Analytics/nd_basketball/lineup_plays", pattern="*.csv", full.names=T, recursive=FALSE)
all_plays <- NULL
nd_score_dif <- 0
...
barplot(min_and_margin$margin_per_40, col = c(1,1,1,1,3,3,3,3,1,3,1,1,1), horiz = TRUE, main = "Margin per 40 Minutes", las = 1, names.arg=rownames(min_and_margin))
min_and_margin$off_court_margin <- nd_score_dif - min_and_margin$player_margins
nd_total_minutes <- 40 * 23
...
barplot(min_and_margin$plusminus_per_40, col = c(1,1,1,1,3,3,3,3,1,3,1,1,1), horiz = TRUE, main = "Plus/Minus per 40 Minutes", las = 1, names.arg=rownames(min_and_margin))
barplot(min_and_margin$plusminus_per_40[-1], col = c(1,1,1,3,3,3,3,1,3,1,1,1), horiz = TRUE, main = "Plus/Minus per 40 Minutes", las = 1, names.arg=rownames(min_and_margin)[-1])
